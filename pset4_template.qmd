...
Partner 2 (name and cnet ID): Zac Shen ()
...
```{python}
pos_2016 = pd.read_csv("/Users/zhaozijing/Documents/GitHub/problem-set-4-zac-tina/pos2016.csv")
...
```{python}
pos_2017 = pd.read_csv("/Users/zhaozijing/Documents/GitHub/problem-set-4-zac-tina/pos2017.csv")
pos_2018 = pd.read_csv("/Users/zhaozijing/Documents/GitHub/problem-set-4-zac-tina/pos2018.csv", encoding='ISO-8859-1')
pos_2019 = pd.read_csv("/Users/zhaozijing/Documents/GitHub/problem-set-4-zac-tina/pos2019.csv", encoding='ISO-8859-1')
...
```{python}
zip_codes_gdf = gpd.read_file("/Users/zhaozijing/Documents/GitHub/problem-set-4-zac-tina/gz_2010_us_860_00_500k.shp")

# Filter for Texas zip codes (Texas zip codes start with 75, 76, or 77)
texas_zip_codes = zip_codes_gdf[zip_codes_gdf['ZCTA5'].str.startswith(('75', '76', '77'))]
...
pos_2016_texas = pos_2016_texas[pos_2016_texas['ZIP_CD'].str.startswith(('75', '76', '77'))]
...
border_states_prefixes = ('70','71', '72', '73', '74','87', '88') 
...
```{python}
# Filter hospital data for Texas and border states in 2016 and count hospitals by ZIP_CD
hospitals_2016_texas_border = pos_2016_texas.groupby('ZIP_CD').size().reset_index(name='hospital_count')
...
zips_withhospital_centroids = zips_texas_borderstates_centroids.merge(
    hospitals_2016_texas_border, on='ZIP_CD', how='left'
)

# Filter to include only zip codes with at least one hospital
